...
import { getCafeProducts, getFuelPrices, getGalleryImages, getStatusBanner } from "@/lib/data";
...
export default async function AdminPage() {
  ...
  const [fuelPrices, statusBanner, cafeProducts, galleryImages] = await Promise.all([
    getFuelPrices(),
    getStatusBanner(),
    getCafeProducts(),
    getGalleryImages(),
